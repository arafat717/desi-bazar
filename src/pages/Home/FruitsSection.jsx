  ...
  return (
    <div className="mb-10 mt-10">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-5 mx-auto gap-2 mt-16 mb-20 px-10">
        ...
        <div className="card bg-base-100 shadow-xl mt-2">
          ...
          <div className="card-body border border-t-orange-100">
            <h2 className="card-title">
              Orange
              <div className="badge badge-secondary">$11.45</div>
            </h2>
        ...
        <div className="card bg-base-100 shadow-xl mt-2">
          ...
          <div className="card-body border border-t-orange-100">
            <h2 className="card-title">
              Mango
              <div className="badge badge-secondary">$14.45</div>
            </h2>
        ...
        <div className="card bg-base-100 shadow-xl mt-2">
          ...
          <div className="card-body border border-t-orange-100">
            <h2 className="card-title">
              Strawberry
              <div className="badge badge-secondary">$41.45</div>
            </h2>
        ...
        <div className="card bg-base-100 shadow-xl mt-2">
          ...
          <div className="card-body border border-t-orange-100">
            <h2 className="card-title">
              Watermelon
              <div className="badge badge-secondary">$45.45</div>
            </h2>
            <p>
      ...
      <div className="flex justify-center mx-auto items-center">
        <button className="btn btn-outline btn-success">Show All Fruits</button>
      </div>
    </div>
  );
};
