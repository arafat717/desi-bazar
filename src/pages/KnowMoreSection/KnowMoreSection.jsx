...
const KnowMoreSection = () => {
  return (
    <div className="flex md:flex-row flex-col justify-evenly gap-16  items-center px-2  md:px-10 my-32">
      ...
      <div className="w-full md:w-1/2">
        ...
        <p className="font-semibold text-sm text-gray-400 my-7">
          ...
          readable content <br /> of a page when looking at its layout. It is a
          long established fact a that a reader will <br /> be distracted by the
          readable content of a page when our looking at its layout.
        </p>
