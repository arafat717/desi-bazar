...
const VegitablesEdit = () => {
  ...
  const onSubmit = async (data) => {
    console.log(data);
    await fetch(`http://localhost:3000/vegitables/${vegitable.id}`, {
      method: "PATCH",
      headers: {
  ...
  return (
    <div className="flex justify-center w-full mx-auto">
      ...
      >
        <h2 className="text-2xl mb-4">Add Vegitables Form</h2>
